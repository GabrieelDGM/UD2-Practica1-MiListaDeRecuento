...
export default function AnimeList() {
    const animes = [
        ...
        },
        {
            ...
            imagen: require("../assets/images/animes/naruto.jpg"),
        },
        {
            id: 3,
            ...
            imagen: require("../assets/images/animes/ataque.jpg"),
        },
        {
            id: 4,
            ...
            imagen: require("../assets/images/animes/kimtesu.jpg"),
        },
        {
            id: 5,
            nombre: "Dandanda",
            ...
            imagen: require("../assets/images/animes/dadan.jpg"),
        },
        {
            id: 6,
            ...
            imagen: require("../assets/images/animes/jujutsu.jpg"),
        },
        {
            id: 7,
            ...
            imagen: require("../assets/images/animes/solo.jpg"),
        },
        {
            id: 8,
            ...
            imagen: require("../assets/images/animes/sono.jpg"),
        ...
        },
        {
            ...
            imagen: require("../assets/images/animes/black.jpg"),
        },
        {
            id: 10,
            nombre: "Monster",
            ...
            imagen: require("../assets/images/animes/monster.jpg"),
        }
